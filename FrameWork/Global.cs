...
namespace ServiceManual
{
    public class Global
    {
        ...
        public static string MainFormTitle = "维修秘籍 " + Assembly.GetExecutingAssembly().GetName().Version;
        //public static string Vesion = Assembly.GetExecutingAssembly().GetName().Version.ToString();
